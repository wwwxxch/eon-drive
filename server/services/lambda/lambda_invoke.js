...
dotenv.config();
const { IAM_USER_ACCESS_KEY_ID, IAM_USER_SECRET_ACCESS_KEY, LAMBDA_REGION, LAMBDA_FUNCTION_NAME } =
	process.env;
...
const callLambdaZip = async (userId, finalListNoVer, finalListWithVer, parentPath, parentName) => {
	// console.log(

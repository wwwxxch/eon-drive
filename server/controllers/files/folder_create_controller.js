...
import { getFolderId } from "../../models/db_files_read.js";
import { createFolder, changeFolderDeleteStatus } from "../../models/db_files_upload.js";
import { commitMetadata } from "../../models/db_files_commit.js";

import { findTargetFolderId } from "../../services/path/iter.js";
import { emitNewList } from "../../services/sync/list.js";
...
const createFolderS3AndDB = async (req, res, next) => {
	...
	if (
		chkDir.length > 0 &&
		chkDir[0].is_delete === 0 &&
		chkDir[0].files_upd_status === "done"
	) {
		// if yes & is_delete === 0

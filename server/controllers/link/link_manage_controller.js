...
import { getMultipleUserId } from "../../models/db_user.js";
import {
	addUserToAccessList,
	changeLinkToPrivate,
	changeLinkToPublic,
...
import { shareTokenGenerator } from "../../services/share/token_gen.js";

import { emitShareNotice, emitLinksYouShared } from "../../services/sync/list.js";
...
const revokeLink = async (req, res, next) => {
	...
	const revokeLinkInDB = await deleteLinkByFilesId(
		userId,
		filesId,
